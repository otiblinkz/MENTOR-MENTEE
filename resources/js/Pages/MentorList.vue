...
import MentorCardList from '@/Components/MentorCardList.vue';
...
<template>
    <Head title="Mentorlist" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Mentor List</h2>
        </template>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div v-if="profileComplete" class="mt-6">
                    <h1 class="text-2xl font-bold mb-4">My Mentors List</h1>
                    <MentorCardList :mentors="mentors"/>
                </div>
